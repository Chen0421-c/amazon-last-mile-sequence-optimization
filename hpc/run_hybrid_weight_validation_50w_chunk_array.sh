#!/bin/bash
#SBATCH --job-name=hybrid_w50_chunk
#SBATCH --output=/home/user/chenziliang/dissertation/amazon_last_mile/final_experiment_outputs/logs/hybrid_w50_chunk_%A_%a.out
#SBATCH --error=/home/user/chenziliang/dissertation/amazon_last_mile/final_experiment_outputs/logs/hybrid_w50_chunk_%A_%a.err
...
echo "Start hybrid validation 50w chunk ${CHUNK_ID}"
date
hostname
...
echo "Finished hybrid validation 50w chunk ${CHUNK_ID}"
date
ls -lh "$OUT"
